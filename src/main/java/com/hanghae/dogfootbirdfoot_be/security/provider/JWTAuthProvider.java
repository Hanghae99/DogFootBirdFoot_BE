...
import com.hanghae.dogfootbirdfoot_be.security.jwt.JwtDecoder;
import com.hanghae.dogfootbirdfoot_be.security.jwt.JwtPreProcessingToken;
...
public class JWTAuthProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication)
        ...
        User user = userRepository.findByUsername(username)
                ...
                // 검증후에 userDetail로 전달해서 인증된 사용자 정도를 이용할 수 있게 한다.
